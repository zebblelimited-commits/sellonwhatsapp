          ...
          <div className="flex flex-col gap-6">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {/* WhatsApp */}
                <a href="#" className="w-10 h-10 rounded-[13px] border border-gray-200 flex items-center justify-center hover:bg-[#f7fee7] hover:border-[#ecfcca] transition-all">
                ...
                {/* X (Twitter) */}
                <a href="#" className="w-10 h-10 rounded-[13px] border border-gray-200 flex items-center justify-center hover:bg-[#f7fee7] hover:border-[#ecfcca] hover:text-black transition-all">
                ...
                {/* Instagram */}
                <a href="#" className="w-10 h-10 rounded-[13px] border border-gray-200 flex items-center justify-center hover:bg-[#f7fee7] hover:border-[#ecfcca] hover:text-pink-600 transition-all">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" /></svg>
                </a>

                {/* Facebook */}
                <a href="#" className="w-10 h-10 rounded-[13px] border border-gray-200 flex items-center justify-center hover:bg-[#f7fee7] hover:border-[#ecfcca] hover:text-blue-600 transition-all">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                </a>

                {/* YouTube */}
                <a href="#" className="w-10 h-10 rounded-[13px] border border-gray-200 flex items-center justify-center hover:bg-[#f7fee7] hover:border-[#ecfcca] hover:text-red-600 transition-all">
