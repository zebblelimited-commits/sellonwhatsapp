...
You can even start selling without building a website.`;
  ...
  const saveBank = async () => {
    ...
    try {
      ...
      setBankForm(payload.payoutSettings);
      setNotice("Account verified as " + payload.payoutSettings.accountName + " and submitted for review");
