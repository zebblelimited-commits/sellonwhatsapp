...
import { 
  ...
  collection, addDoc // ✅ Ensure these are imported for dispute creation
} from "firebase/firestore";
import { 
  ArrowLeft, ShieldCheck, Package, MessageCircle, CheckCircle2, 
  AlertCircle, Truck, Clock, Flag, Loader2, ExternalLink 
} from "lucide-react";
...
export default function OrderDetailsPage() {
    ...
    // ✅ SECURE: Confirm receipt via Cloud Function pattern (client signals intent)
    const handleConfirmReceipt = async () => {
        ...
        setProcessing(true);
        try {
            // 🔐 In production: Call a Cloud Function instead of direct Firestore write
            // const { confirmOrderReceipt } = require("@/lib/cloudFunctions");
            // await confirmOrderReceipt({ orderId: id });
            
            // For dev: Direct update (replace with Cloud Function in prod)
            ...
            // ✅ Show success modal feedback instead of standard window alert
            setShowConfirmModal(false);
            setShowSuccessModal(true);
            
            // ✅ Optional: Trigger analytics
            // trackEvent("order_confirmed", { orderId: id, amount: order.totalAmount });
    ...
    return (
        <div className="max-w-2xl mx-auto p-4 pb-32 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            {/* Escrow Shield Info */}
            <div className={`rounded-3xl p-5 mb-6 flex items-start gap-4 ${
                isDisputed 
              ...
              <div className="bg-red-50 border border-red-100 rounded-3xl p-5 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <button 
                      // ✅ Navigate to buyer disputes tab
            ...
            {/* ✅ Bottom Actions - Inline with content */}
            <div className="space-y-3 pt-6 border-t border-gray-100">
              ...
              {!isDisputed && (isCompleted || isShipped) && (
                <button 
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-4 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 shadow-sm transition-all"
              >
...
{/* ✅ Dispute Modal - Unchanged, works as before */}
{showDisputeModal && (
  <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
    <div className="bg-white w-full max-w-md rounded-[32px] p-6 shadow-2xl">
      ...
      <p className="text-sm text-gray-500 mb-4">
        Describe the issue with your order. Funds remain held in escrow until resolved.
      </p>
      ...
      <div className="space-y-4">
        ...
        >
          {processing ? (
            ...
            {/* ✅ Order Receipt Confirmation Modal Popup */}
            {showConfirmModal && (
                    ...
                    <div className="bg-white w-full max-w-sm rounded-[32px] p-6 shadow-2xl animate-in zoom-in-95 duration-200">
                        <div className="flex flex-col items-center text-center">
                            ...
                            <div className="w-full flex flex-col gap-2">
                                ...
                                >
                                    {processing ? (
                                        <><Loader2 size={16} className="animate-spin" /> Releasing Funds...</>
                                    ) : (
                                        "Yes, Release Funds"
                                    )}
                                </button>
